...
export default function Page() {
  return (
    <MarketplaceShell eyebrow="GÜVENLİK" title="Hesap doğrulama" description="E-posta ve telefon doğrulamasını tamamlayarak güvenli teklif ve satış işlemlerini etkinleştir." compact>
