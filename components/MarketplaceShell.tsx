  ...
  return (
    <main className="marketApp">
      <header className="marketHeader">
        ...
        <form className="marketSearch" action="/arama">
          <span>⌕</span>
          <input name="q" placeholder="Ürün, kategori veya marka ara..." />
          <button type="submit">Ara</button>
        </form>
        <nav className="marketTopActions">
          <Link href="/bildirimler" aria-label="Bildirimler">♢<small>3</small></Link>
          <Link href="/favoriler" aria-label="Favoriler">♡</Link>
          <Link href="/profil" className="marketAvatar">K</Link>
