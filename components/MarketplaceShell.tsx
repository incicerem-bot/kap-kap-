...
const commonAccount = [
  ["/profil", "Hesap Özeti"], ["/hesap-dogrulama", "Hesap Doğrulama"], ["/teklif-guvencesi", "Teklif Güvencesi"], ["/tekliflerim", "Tekliflerim"],
...
export default function MarketplaceShell({ title, eyebrow, description, children, action, compact = false }: {
  ...
  const accountItems = user
    ? [
        ...
        ...(isSeller ? [["/magazam", "Mağazam"], ["/ilanlarim", "İlanlarım"], ["/magazam/ayarlar", "Mağaza Ayarları"], ["/satici-dogrulama", "Satıcı Doğrulama"]] : [["/satici-dogrulama", isSellerCandidate ? "Satıcı Başvurusu" : "Satıcı Ol"]]),
