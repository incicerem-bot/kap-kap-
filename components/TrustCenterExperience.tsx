...
const initialDisputes: Dispute[] = [
  {
    id: "UY-2026-1842", orderId: "KK-24891", product: "CS2 Karambit Doppler", seller: "Skin Station", amount: "85.000 TL", reason: "Skin bilgisi uyuşmuyor", details: "İlanda belirtilen float değeri ile takas ekranındaki değer farklı görünüyor. Aynı gün ekran görüntülerini ekledim.", status: "review", opened: "19 Temmuz 2026 · 09:24", deadline: "Tahmini karar: 22 Temmuz", image: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=500&q=80", evidence: ["ilan-float.png", "takas-ekrani.png"],
  },
  {
  ...
  {
    id: "UY-2026-1631", orderId: "KK-23904", product: "HyperX Cloud III Gaming Kulaklık", seller: "Ses Oyuncu", amount: "5.250 TL", reason: "Kargo gecikmesi", details: "Kargo firması kaynaklı gecikme yaşandı. Ürün daha sonra teslim edildi ve işlem tamamlandı.", status: "resolved", opened: "9 Temmuz 2026 · 11:16", deadline: "12 Temmuz 2026 tarihinde çözüldü", image: "https://images.unsplash.com/photo-1599669454699-248893623440?auto=format&fit=crop&w=500&q=80", evidence: ["kargo-takip.pdf"],
  },
];
