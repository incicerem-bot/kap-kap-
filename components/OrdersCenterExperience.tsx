...
const demoOrders: DisplayOrder[] = [
  { id: "KK-24891", title: "CS2 Karambit Doppler", seller: "Skin Station", sellerSlug: "skin-station", amount: 85000, state: "shipped", date: "18 Temmuz 2026", image: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=700&q=80", tracking: "Dijital teslimat", carrier: "Steam Takası", eta: "Teslimat bekleniyor", paymentStatus: "paid", winnerRank: 1, offerType: "winner" },
  ...
  { id: "KK-24118", title: "Knight Online Raptor +9", seller: "Knight Pazarı", sellerSlug: "knight-pazari", amount: 75000, state: "payment", date: "19 Temmuz 2026", image: "https://images.unsplash.com/photo-1542751110-97427bbecf20?auto=format&fit=crop&w=700&q=80", tracking: "", carrier: "Oyun İçi Teslimat", eta: "İşlem sonrası planlanır", paymentDueAt: new Date(Date.now() + 15 * 60 * 1000).toISOString(), paymentStatus: "unpaid", winnerRank: 1, offerType: "winner" },
