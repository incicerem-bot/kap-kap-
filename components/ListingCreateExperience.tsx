...
const categories = [
  ...
  { id: "nintendo-games", db: "gaming", label: "Nintendo Oyunları" },
  { id: "steam-codes", db: "gaming", label: "Steam Cüzdan ve Kod" },
  { id: "epin-gift-card", db: "gaming", label: "E-pin ve Hediye Kartı" },
  ...
  { id: "valorant", db: "gaming", label: "Valorant Ürünleri" },
  { id: "league-of-legends", db: "gaming", label: "League of Legends Ürünleri" },
  { id: "pubg-mobile", db: "gaming", label: "PUBG Mobile Ürünleri" },
  { id: "roblox", db: "gaming", label: "Roblox Ürünleri" },
  { id: "mobile-legends", db: "gaming", label: "Mobile Legends Ürünleri" },
  { id: "gaming-mouse", db: "electronics", label: "Gaming Mouse" },
  { id: "gaming-keyboard", db: "electronics", label: "Gaming Klavye" },
  { id: "gaming-headset", db: "electronics", label: "Gaming Kulaklık" },
  { id: "gaming-mousepad", db: "electronics", label: "Gaming Mousepad" },
  { id: "gaming-monitor", db: "electronics", label: "Gaming Monitör" },
  { id: "gaming-chair", db: "collection", label: "Oyuncu Koltuğu" },
